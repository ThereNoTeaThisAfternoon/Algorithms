...
//    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        while ((line = in.readLine()) != null) {
            int[] start1 = stringToIntegerArray(line);
            line = in.readLine();
            int[] end1 = stringToIntegerArray(line);
            line = in.readLine();
            int[] start2 = stringToIntegerArray(line);
            line = in.readLine();
            int[] end2 = stringToIntegerArray(line);

            double[] ret = new Solution().intersection(start1, end1, start2, end2);

//            String out = doubleArrayToString(ret);
            String out = "result -> ["+ ret[0] +","+ret[1]+"]";
